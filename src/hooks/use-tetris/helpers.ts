import type { TetrisSpace } from '@/lib/types'
import { Direction, TetrisBlock } from '@/lib/types'
...
export function rotateSRSKick(
    ...
    const offsetList = block == TetrisBlock.I ? iOffsets : block == TetrisBlock.O ? oOffsets : offsets
